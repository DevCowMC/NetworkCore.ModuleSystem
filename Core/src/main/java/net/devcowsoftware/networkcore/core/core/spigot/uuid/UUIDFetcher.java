package net.devcowsoftware.networkcore.core.core.spigot.uuid;
...
public class UUIDFetcher {
     ...
     * @see net.devcowsoftware.networkcore.core.Core.spigot.uuid.UUIDFetcher#getUUIDAt(String, long)
     */
     ...
     * @param name The name
     * @param timestamp Time when the player had this name in milliseconds
     * @see net.devcowsoftware.networkcore.core.Core.spigot.uuid.UUIDFetcher#FEBRUARY_2015
     */
